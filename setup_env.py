...
def compile():
    ...
    run_command(["cmake", "-G", "Ninja", "-B", "build", *COMPILER_EXTRA_ARGS[arch], *OS_EXTRA_ARGS.get(platform.system(), []), "-DCMAKE_C_COMPILER=gcc", "-DCMAKE_CXX_COMPILER=g++"], log_step="generate_build_files")
